...
public class CraftConsoleCommandSender implements ConsoleCommandSender {
    ...
    private String translate(String text) {
        ...
        // Basic mapping for common Minecraft color codes
    ...
    @Override public @NotNull net.kyori.adventure.text.Component name() {
    ...
    @Override public void abandonConversation(@NotNull Conversation conversation, @NotNull ConversationAbandonedEvent abandonedEvent) {}

    @Override public void acceptConversationInput(@NotNull String input) {}

    @Override public boolean beginConversation(@NotNull Conversation conversation) {
        return false;
    }
    ...
    @Override public void sendRawMessage(@Nullable UUID sender, @NotNull String message) {
        sendMessage(message);
    }
}
