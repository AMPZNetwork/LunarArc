...
public class CraftServer implements Server {
    ...
    public CraftServer(MinecraftServer console, PlayerList playerList) {
        ...
        this.pluginManager.registerInterface(io.ampznetwork.lunararc.common.server.LunarArcPluginLoader.class);
    ...
    public @NotNull Collection<? extends Player> getOnlinePlayers() {
        ...
        for (net.minecraft.server.level.ServerPlayer player : playerList.getPlayers()) {
            players.add(new CraftPlayer(player));
        }
        return players;
    }
    ...
    public @NotNull List<World> getWorlds() {
        ...
        for (net.minecraft.server.level.ServerLevel level : console.getAllLevels()) {
            worlds.add(new CraftWorld(level));
        }
        return worlds;
    }
    ...
    public void loadPlugins() {
        System.out.println("[LunarArc] Loading plugins...");
        File pluginsFolder = new File("plugins");
        if (!pluginsFolder.exists()) {
            pluginsFolder.mkdirs();
        }
        // The actual loading is handled by the Mixin or a manual call
    }
    ...
    public boolean dispatchCommand(@NotNull CommandSender sender, @NotNull String commandLine) {
        try {
            ...
            System.err.println("[LunarArc] Error dispatching command: " + commandLine);
            e.printStackTrace();
            return false;
        }
    }
