...
public final class PluginCompatibilityRegressionTest {
    public static void main(String[] args) throws Exception {
        ...
        io.ampznetwork.lunararc.common.server.EssentialsAliasRegressionTest.run();
        ...
        try {
            ...
            check(io.ampznetwork.lunararc.common.server.LunarArcPluginFixManager.translationEntries(null).isEmpty(),
                    "empty translations did not fall back");
            check(io.ampznetwork.lunararc.common.server.LunarArcPluginFixManager.translationEntries(
            ...
            var filtered = io.ampznetwork.lunararc.common.compat.MarketRecipeFilter.filter(recipes,
