...
import io.ampznetwork.lunararc.common.debug.LunarArcPluginDebug;
import io.ampznetwork.lunararc.common.server.LunarArcTimings;
...
public final class DebugOptionsRegressionTest {
    public static void main(String[] args) throws Exception {
        ...
        var launcher = Class.forName("io.ampznetwork.lunararc.launcher.StartupTimer");
        ...
        if (mode.equals("off")) {
            ...
            var loader = io.ampznetwork.lunararc.common.server.LunarArcPluginLoader.class;
            io.ampznetwork.lunararc.common.server.LunarArcPluginLoader.warnJavaVersionOnce(Path.of("first.jar"), error);
            io.ampznetwork.lunararc.common.server.LunarArcPluginLoader.warnJavaVersionOnce(Path.of("./first.jar"), error);
            io.ampznetwork.lunararc.common.server.LunarArcPluginLoader.warnJavaVersionOnce(Path.of("second.jar"), error);
