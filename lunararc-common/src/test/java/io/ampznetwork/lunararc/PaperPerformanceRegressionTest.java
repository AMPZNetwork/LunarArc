...
public final class PaperPerformanceRegressionTest {
    public static void run() throws Exception {
        ...
        var lookupThread = io.ampznetwork.lunararc.common.server.LunarArcProfileLookupExecutor.executor()
        ...
        var decoder = new io.ampznetwork.lunararc.common.mixin.core.network.Varint21FrameDecoderMixin() {};
